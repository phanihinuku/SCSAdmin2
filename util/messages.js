jQuery.sap.declare("com.scs.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.scs.util.messages = {};
 ...
 * @public
 */
com.scs.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.scs.util.messages._parseError(oParameter);
...
com.scs.util.messages.getErrorContent = function(oParameter) {
	return com.scs.util.messages._parseError(oParameter).sMessage;
};

com.scs.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
