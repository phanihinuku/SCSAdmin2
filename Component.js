...
jQuery.sap.declare("com.scs.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("com.scs.Component", {
	metadata: {
		"name": "SCSAdmin2",
	...
	init: function() {
		...
		var sRootPath = jQuery.sap.getModulePath("com.scs");
	...
	_initODataModel: function(sServiceUrl) {
		jQuery.sap.require("com.scs.util.messages");
		var oConfig = {
			metadataUrlParams: {},
			json: true,
		...
		oModel.attachRequestFailed(null, com.scs.util.messages.showErrorMessage);
